...
public class TreasureManager : MonoBehaviour
{
    ...
    [SerializeField] public float spawnTime = 0f;            // How long between each spawn.
    [SerializeField] public float SpawnRadius = 1000;
    [SerializeField] public int spawnNumber = 15;
